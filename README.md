...
If you want to override the default proxy settings for the nginx container, add a configuration file at `/etc/nginx/proxy_settings.conf`. A file with the default settings would
look like this:

```/etc/nginx/proxy_settings.conf
# HTTP 1.1 support
